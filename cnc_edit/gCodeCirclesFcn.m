...
% Check existence of I field in the given line's coordinates
if ~(isfield(line.coord,'I') && isfield(line.coord,'J'))
    disp(strcat('No i or j code specified, continuing, circle not checked',line.lineNum))
    return
end
% disp(
